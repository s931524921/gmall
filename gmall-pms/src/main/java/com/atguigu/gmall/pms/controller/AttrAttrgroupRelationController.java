...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteAttrRelation(@RequestBody List<AttrAttrgroupRelation> attrgroupRelationList) {

        this.attrAttrgroupRelationService.deleteAttrRelation(attrgroupRelationList);
        return Resp.ok("删除成功");
    }
